...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is BKBasicTools
                   DESC

  s.homepage     = "https://gitlab.com/bluajack-BasicComponents/BKBasicTools"
  ...
  s.source       = { :git => "https://gitlab.com/bluajack-BasicComponents/BKBasicTools.git", :tag => s.version.to_s }
  ...
  s.source_files  = "BKBasicTools/BKBasicTools/**/*.{h,m,swift}"
